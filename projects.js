const projectList = [
    ...
    {title: "Cold Plunges for Him: When the For You Page Isn't for Me", url:"https://cold-plunge-six.vercel.app/", tag: "data-visualization,writing", img: "./img/project/cold%20plunge.jpg", description: "An analysis of 212 PubMed articles revealed that most cold therapy studies excluded women, yet this bias disappears as findings spread into health media. This project traces how advice based on male physiology gets generalized into universal health tips.<p><em>Python, HTML, CSS, Javascript, D3.js</em></p>"},
    {title: "SNU NOW Articles", url: "https://en.snu.ac.kr/snunow/snu_media/news?CSRFToken=8b3712189bb5cd94afbd69e57d1ddd91ec04e2715c994dfd325368bb95b615d0&sc=y&df=&dt=&qt=b&q=hyun+jooyoung", tag: "writing", img:"./img/project/snunow.png", description: "Wrote monthly articles for Seoul National University's official newsletter, SNU NOW."},
