const projectList = [
    ...
    {title: "Cold Plunges for Him: When the For You Page Isn't for Me", url:"https://zoo-zer0.github.io/project5/", tag: "data-visualization,writing", img: "./img/project/cold%20plunge.jpg", description: "An analysis of 212 PubMed articles revealed that most cold therapy studies excluded women, yet this bias disappears as findings spread into health media. This project traces how advice based on male physiology gets generalized into universal wellness claims.<p><em>Python, HTML, CSS, Javascript, D3.js</em></p>"},
